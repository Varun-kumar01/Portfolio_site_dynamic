...
<<<<<<< HEAD
  const getLocalizedNews = (item) => {
    ...
    const translationKey = `news.items.news${item.id}`;
    const englishTitle = i18n.getFixedT("en")(`${translationKey}.title`, {
      defaultValue: "",
    });
    ...
    const translatedDescription = t(`${translationKey}.description`, {
      defaultValue: item.description || item.content || "",
    });
